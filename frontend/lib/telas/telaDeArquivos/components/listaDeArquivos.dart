                      ...
                      children: [
                        Padding(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () async {
                                try {
                                  // Seleciona uma pasta usando o file_picker
                                  String? folderPath = await FilePicker.platform
                                      .getDirectoryPath();

                                  if (folderPath != null) {
                                    // Faça algo com o caminho da pasta selecionada
                                   dynamic resposta= await download(tr.idExterno, _tokenLogin,folderPath);   
                                   print(resposta.runtimeType);                                 // Aqui você pode armazenar o caminho da pasta como quiser, por exemplo, em um estado, banco de dados, etc.
                                  }
                                } catch (e) {
